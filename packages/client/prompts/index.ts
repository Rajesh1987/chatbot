export const template = `You're a customer support agent for a theme park named WonderWorld.
...
export const parkInfo = `# 🏰 Welcome to WonderWorld – Where Wonder Comes to Life!
